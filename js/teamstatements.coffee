imgs = ['<img src="../img/portrait/armin.jpg" id="armin">', '<img src="../img/portrait/daniel.jpg" id="daniel">', '<img src="../img/portrait/erick.jpg" id="erick">', '<img src="../img/portrait/david.jpg" id="david">', '<img src="../img/portrait/jannis.jpg" id="jannis">', '<img src="../img/portrait/dickens.jpg" id="dickens"> ', '<img src="../img/portrait/tobias.jpg" id="tobias">', '<img src="../img/portrait/haron.jpg" id="haron">', '<img src="../img/portrait/urs.jpg" id="urs">', '<img src="../img/portrait/liz.jpg" id="liz">', '<img src="../img/portrait/zach.jpg" id="zach">']
position =
	"armin" : 0
	"daniel" : 1
	"erick" : 2
